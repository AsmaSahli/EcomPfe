          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {isEmpty ? t('profile.wishlist.emptySubtitle') : `${wishlistItems.length} loved items`}
              </p>
            </div>
          </div>
          {!isEmpty && (
            ...
            >
              ...
              {displayItems.map((item, index) => (
                <motion.div
                  ...
                  className={`absolute w-44 h-60 rounded-2xl shadow-lg overflow-hidden cursor-pointer ${
                    index === 0 ? 'z-20 border-2 border-white shadow-xl' : 
                    index === 1 ? 'z-18 opacity-95' :
                    index === 2 ? 'z-16 opacity-90' :
                    index === 3 ? 'z-14 opacity-85' :
                    'z-12 opacity-80'
                  }`}
                  style={{
                    backgroundImage: `url(${item.productId.images[0]?.url || '/placeholder-product.jpg'})`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    transformOrigin: 'bottom center'
                  }}
                >
                  <Link to={`/product/${item.productId.slug}`} className="block h-full w-full">
                    {/* Gradient overlay */}
              ...
              {wishlistItems.length > displayItems.length && (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 font-medium">More loves</p>
